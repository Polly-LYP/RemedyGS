...
class DL3DV_MV_Images(Dataset):
    ...
    def __getitem__(self, index):
        ...
        clean_root = "/home/ylitx/Project/25_4/RemedyGS_Apr/Our_Main/In_domain_exp/Sampled_dataset/100"
        clean_image = []
        for item in image_batch:
            scene_name = item.split('/')[-3]
            image_name = item.split('/')[-1]
            image_path = os.path.join(clean_root,scene_name,'images_4',image_name)
