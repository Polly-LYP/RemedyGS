...
class Tanks_MV_Images(Dataset):
    ...
    def __init__(self, img_per_batch=4, root="/home/ylitx/Project/25_4/RemedyGS_Apr/Our_Main/In_domain_exp/Sampled_dataset/100",
                ...
                crop_size=(544,1056), subset="test"):
        """
        Args:
    ...
    def __getitem__(self, index):
        ...
        without_resized_images = [(transform_without_resize(Image.open(img).convert('RGB')).shape[1],transform_without_resize(Image.open(img).convert('RGB')).shape[2]) for img in image_batch]


        return images,image_batch,without_resized_images
