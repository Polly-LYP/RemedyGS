...
class DL3DV_MV_Images(Dataset):
    ...
    def __getitem__(self, index):
        ...
        # get attacked image
        attacked_root = "/home/ylitx/Project/25_4/RemedyGS_Apr/Our_Main/In_domain_exp/Sampled_dataset/attacked/attacker_output_sampled_100_30000_25/100_eps50"
        attacked_image = []
        for image in image_batch:
            scene_name = image.split('/')[-3]
            image_name = image.split('/')[-1]
            image_path = os.path.join(attacked_root,scene_name,'images_4',image_name)
