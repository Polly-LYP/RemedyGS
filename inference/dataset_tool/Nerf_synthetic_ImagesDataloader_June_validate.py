...
class Nerf_MV_Images_validate(Dataset):
    ...
    def __getitem__(self, index):
        ...
        # get attacked image
        attacked_root = "/home/ylitx/Project/25_4/RemedyGS_Apr/Main/poison-splat/dataset/Nerf_Synthetic_eps16"
        attacked_image = []
        for image in image_batch:
            scene_name = image.split('/')[-3]
            image_name = image.split('/')[-1]
            image_path = os.path.join(attacked_root,scene_name,'train',image_name)
